...
```
RB13@ubuntu:~/0x12$ ./0-javascript_is_amazing.js
JavaScript is amazing
RB13@ubuntu:~/0x12$
RB13@ubuntu:~/0x12$ semistandard ./0-javascript_is_amazing.js
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ ./1-multi_languages.js
C is fun
Python is cool
JavaScript is amazing
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ ./2-arguments.js
No argument
RB13@ubuntu:~/0x12$ ./2-arguments.js Best
Argument found
RB13@ubuntu:~/0x12$ ./2-arguments.js Best School
Arguments found
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ ./3-value_argument.js
No argument
RB13@ubuntu:~/0x12$ ./3-value_argument.js School
School
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ ./4-concat.js c cool
c is cool
RB13@ubuntu:~/0x12$ ./4-concat.js c
c is undefined
RB13@ubuntu:~/0x12$ ./4-concat.js
...
```
RB13@ubuntu:~/0x12$ ./5-to_integer.js
Not a number
RB13@ubuntu:~/0x12$ ./5-to_integer.js 89
My number: 89
RB13@ubuntu:~/0x12$ ./5-to_integer.js "89"
My number: 89
RB13@ubuntu:~/0x12$ ./5-to_integer.js 89.89
My number: 89
RB13@ubuntu:~/0x12$ ./5-to_integer.js School
Not a number
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ ./6-multi_languages_loop.js
C is fun
Python is cool
JavaScript is amazing
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ ./7-multi_c.js 2
C is fun
C is fun
RB13@ubuntu:~/0x12$ ./7-multi_c.js 5
C is fun
C is fun
C is fun
C is fun
C is fun
RB13@ubuntu:~/0x12$ ./7-multi_c.js
Missing number of occurrences
RB13@ubuntu:~/0x12$ ./7-multi_c.js -3
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ ./8-square.js
Missing size
RB13@ubuntu:~/0x12$ ./8-square.js School
Missing size
RB13@ubuntu:~/0x12$ ./8-square.js 2
XX
XX
RB13@ubuntu:~/0x12$ ./8-square.js 6
XXXXXX
XXXXXX
XXXXXX
XXXXXX
XXXXXX
XXXXXX
RB13@ubuntu:~/0x12$ ./8-square.js -3
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ ./9-add.js
NaN
RB13@ubuntu:~/0x12$ ./9-add.js 1
NaN
RB13@ubuntu:~/0x12$ ./9-add.js 1 7
8
RB13@ubuntu:~/0x12$ ./9-add.js 13 89
102
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ ./10-factorial.js
1
RB13@ubuntu:~/0x12$ ./10-factorial.js 3
6
RB13@ubuntu:~/0x12$ ./10-factorial.js 89
1.6507955160908452e+136
RB13@ubuntu:~/0x12$ ./10-factorial.js 333
Infinity
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ ./11-second_biggest.js
0
RB13@ubuntu:~/0x12$ ./11-second_biggest.js 1
0
RB13@ubuntu:~/0x12$ ./11-second_biggest.js 4 2 5 3 0 -3
4
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ cat 12-object.js
#!/usr/bin/node
const myObject = {
  type: 'object',
  value: 12
...
```
RB13@ubuntu:~/0x12$ cat 13-main.js
#!/usr/bin/node
const add = require('./13-add').add;
console.log(add(3, 5));
RB13@ubuntu:~/0x12$ ./13-main.js
8
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ cat 100-main.js
#!/usr/bin/node
myVar = 89;
require('./100-let_me_const')
console.log(myVar);
RB13@ubuntu:~/0x12$ ./100-main.js
333
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ cat 101-main.js
#!/usr/bin/node
const callMeMoby = require('./101-call_me_moby').callMeMoby;
callMeMoby(3, function () {
  console.log('C is fun');
});
RB13@ubuntu:~/0x12$ ./101-main.js
C is fun
C is fun
C is fun
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ cat 102-main.js
#!/usr/bin/node
const addMeMaybe = require('./102-add_me_maybe').addMeMaybe;
addMeMaybe(4, function (nb) {
  console.log('New value: ' + nb);
});
RB13@ubuntu:~/0x12$ ./102-main.js
New value: 5
RB13@ubuntu:~/0x12$
...
```
RB13@ubuntu:~/0x12$ cat 103-object_fct.js
#!/usr/bin/node
const myObject = {
  type: 'object',
  value: 12
...
RB13@ubuntu:~/0x12$ ./103-object_fct.js
{ type: 'object', value: 12 }
